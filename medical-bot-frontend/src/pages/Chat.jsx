...
export default function Chat() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans overflow-hidden">
      <SEO
        title="Chat with AI"
        description="Secure, private medical chat interface. Ask questions and get instant health guidance."
        canonical="https://medguide-ai.com/chat"
        type="article"
      />
      ...
      <main className="flex-1 flex pt-14">
        ...
        <aside className={`fixed left-0 top-14 w-64 h-[calc(100vh-3.5rem)] bg-white border-r border-gray-200 flex-shrink-0 overflow-y-auto z-40 transition-transform duration-300 ease-in-out ${isMobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'
          ...
          <div className="p-4">
            ...
            <div className="p-4 border-t border-gray-200">
              ...
              <div className="mt-4 flex items-center justify-between text-xs text-gray-500">
                <span>Powered by MedGuide AI</span>
                <span>v1.0</span>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto md:ml-64">
              <div className="relative">
                <div className="flex items-center bg-white border-2 border-gray-200 rounded-2xl px-4 md:px-6 py-3 md:py-4 focus-within:ring-4 focus-within:ring-blue-100 focus-within:border-blue-500 transition-all duration-200 shadow-lg hover:shadow-xl">
                  <button
                    disabled={isLoading}
                    className={`mr-3 md:mr-4 p-2 rounded-xl transition-all duration-200 ${isLoading
                  ...
                  <button
                    ...
                    className={`ml-3 md:ml-4 p-2 rounded-xl transition-all duration-200 ${isLoading
                      ? 'text-gray-300 cursor-not-allowed'
                      : 'text-gray-400 hover:text-blue-600 hover:bg-blue-50'
                      }`}
                  >
